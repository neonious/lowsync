.. lowrmtdoc documentation master file, created by
...
First, install lowrmt

.. code-block:: bash

    npm install -g lowrmt

After installing lowrmt, run

.. code-block:: bash

    lowrmt init

The program will ask you some questions and the configuration file *lowrmt.config.json* will be created in the current working directory.
